...
import 'package:scanner/models/recognition.dart';
import 'package:scanner/utils/image_utils.dart';
...
class Detector {
  static const String _modelPath = 'assets/detect2.tflite';
...
//     final cpuDelegate = CpuDelegate(
//   options: CpuDelegateOptions(
//     numThreads: 4, // Set the number of CPU threads to use
//     powerprefernce: CpuDelegateOptions.POWER_PREFERENCE_LOW_LATENCY,
//   ),
// );
